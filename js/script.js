...
function CreateCookies()
{
	...
	ExpDate1.setTime(ExpDate1.getTime() + 1000*60*60*24*7);
	var cookieStr = CookieName + "=" + CookieValue + "; " +  "path=/" + "; " + "expires=" + ExpDate1.toUTCString();
	document.cookie = cookieStr;	
	
	var CookieName = "targetingCookie2";
	var CookieValue = "value2";
	var ExpDate2 = new Date();
	ExpDate2.setTime(ExpDate2.getTime() + 1000*60*60*24*7);
	var cookieStr = CookieName + "=" + CookieValue + "; " +  "path=/" + "; " + "expires=" + ExpDate2.toUTCString();
	document.cookie = cookieStr;
	
	var CookieName = "functionalCookie1";
	var CookieValue = "value3";
	var ExpDate3 = new Date();
	ExpDate3.setTime(ExpDate3.getTime() + 1000*60*60*24*7);
	var cookieStr = CookieName + "=" + CookieValue + "; " +  "path=/" + "; " + "expires=" + ExpDate3.toUTCString();
	document.cookie = cookieStr;
	
	var CookieName = "performanceCookie1";
	var CookieValue = "value4";
	var ExpDate4 = new Date();
	ExpDate4.setTime(ExpDate4.getTime() + 1000*60*60*24*7);
	var cookieStr = CookieName + "=" + CookieValue + "; " +  "path=/" + "; " + "expires=" + ExpDate4.toUTCString();
	document.cookie = cookieStr;
}
